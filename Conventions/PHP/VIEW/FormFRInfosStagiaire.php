...
$formation = FormationsManager::findById($stagiaire[0]->getIdFormation());
...
echo '<div class="info colonne">
    ...
    <div class="mini"></div>
        ...
        <div class="mini"></div>
        <div class="info colonne center">
            <label for="Formateur">En formation de:</label>
            <input type="text" disabled id="Formation" name="Formation" value="'. $formation->getLibelleFormation().'">
        </div>
        <div class="mini"></div>
        </div>
    <div>
    ...
    <div>
        ...
        <div class="mini"></div>
        <div class="info colonne center"></div>
        <div class="mini"></div>
    </div>
';
