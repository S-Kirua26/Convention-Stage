...
class StagiaireFormationManager
{
    ...
    {
        $db = DbConnect::getDb();
        $q = $db->prepare("INSERT INTO StagiaireFormation (libelleFormation,idSessionFormation,numOffreFormation,idPeriode,dateDebutPAE,dateFinPAE,dateRapportSuivi,objectifPAE,dateDebut,dateFin,idStagiaire,genreStagiaire,nomStagiaire,prenomStagiaire,numSecuStagiaire,numBenefStagiaire,dateNaissanceStagiaire,emailStagiaire) VALUES (:libelleFormation,:idSessionFormation,:numOffreFormation,:idPeriode,:dateDebutPAE,:dateFinPAE,:dateRapportSuivi,:objectifPAE,:dateDebut,:dateFin,:idStagiaire,:genreStagiaire,:nomStagiaire,:prenomStagiaire,:numSecuStagiaire,:numBenefStagiaire,:dateNaissanceStagiaire,:emailStagiaire)");
    ...
    {
        $db = DbConnect::getDb();
        $q = $db->prepare("UPDATE StagiaireFormation SET idFormation=:idFormation,libelleFormation=:libelleFormation,idSessionFormation=:idSessionFormation,numOffreFormation=:numOffreFormation,idPeriode=:idPeriode,dateDebutPAE=:dateDebutPAE,dateFinPAE=:dateFinPAE,dateRapportSuivi=:dateRapportSuivi,objectifPAE=:objectifPAE,dateDebut=:dateDebut,dateFin=:dateFin,idStagiaire=:idStagiaire,genreStagiaire=:genreStagiaire,nomStagiaire=:nomStagiaire,prenomStagiaire=:prenomStagiaire,numSecuStagiaire=:numSecuStagiaire,numBenefStagiaire=:numBenefStagiaire,dateNaissanceStagiaire=:dateNaissanceStagiaire,emailStagiaire=:emailStagiaire WHERE idFormation=:idFormation");
